...
class WordProfanity():
    def __init__(self):
        ...
        self.lstm_out = 20
        self.profanity_model = load_model('output/word_model/model.h5')
    ...
    def deep_model(self,model, X_train, y_train, X_valid, y_valid):
        ...
        model.fit(X_train
                    ...
                    , verbose=1)
        model.save("./output/word_model/model.h5")
    ...
    def process_dataset(self):
        ...
        with open('./output/word_model/tk.pickle', 'wb') as handle:
    ...
    def load_model(self):
        model = load_model('output/word_model/model.h5')
        return model
    ...
    def predict(self,request):
        with open('./output/word_model/tk.pickle', 'rb') as handle:
...
request ={
    ...
    [
        ...
        {
            "headName":"MiddleName",
            "headValue":"shit you are so pussy",
            "status":"True",
            "message":""
        },
        {
        ...
        },
        {
            ...
            "headValue":"Oe danthe k ho hero banya ho",
            "status":"True",
            "message":""
        }
    ]
